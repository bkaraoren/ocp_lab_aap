...
echo ""
echo "9. CERTIFICATE RENEWAL AUTOMATION (AAP)"
echo "   Setup automated cert renewal (requires AAP to be running):"
echo "   cd ansible/"
echo "   ansible-playbook playbooks/setup-cert-renewal-job.yml -e @vars/secrets.yml --ask-vault-pass"
echo "   Or manually apply GitOps CRs:"
echo "   oc apply -k ${GITOPS_DIR}/apps/cert-renewal/"
echo ""